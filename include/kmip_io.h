...
void kmip_print_link_type_enum(FILE *, enum link_type);
...
void kmip_print_link(FILE *, int, Link *);
...
void kmip_print_rekey_request_payload(FILE *, int, RekeyRequestPayload *);
void kmip_print_rekey_response_payload(FILE *, int, RekeyResponsePayload *);
